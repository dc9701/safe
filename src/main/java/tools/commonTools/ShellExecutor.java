...
public class ShellExecutor{
	...
	private static String testRoot = CommonTools.getTestRoot();
	private static JsonNode initialConfig = CommonTools.getDataFromConfigFile(testRoot + initialConfigFilePath);
	private static String FILEDIR = testRoot + "data/sal/";
	private String IP = CommonTools.getConfigValue(initialConfig, "ip");
	private String DEVICEIP = CommonTools.getConfigValue(initialConfig, "deviceip");
	private String USER = CommonTools.getConfigValue(initialConfig, "user");
	private String PASSWORD = CommonTools.getConfigValue(initialConfig, "password");
	private String LOCALFILE = CommonTools.getConfigValue(initialConfig, "localFile");
	private String REMOTEDIR = CommonTools.getConfigValue(initialConfig, "remoteDir");
